...
export default function Home() {
  return (
    <main className="flex h-full flex-col items-center justify-center gap-2 bg-lime-300 py-20 lg:flex-row">
      <Image
        src="/logo.svg"
      ...
      <div className="flex flex-col px-3">
        ...
        <div className="flex flex-col items-center gap-2">
          <Link className="w-full" href="/signup">
            <button className="mt-4 w-full rounded bg-lime-400 px-4 py-2 font-bold text-white transition-all duration-300 hover:scale-105 hover:bg-lime-500">
              Get Started
            </button>
          </Link>
          <a
